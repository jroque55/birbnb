  ...
  return (
    <>
      <div className="datos-bg">
        <h2 className="nombre-hotel"> {alojamientosMock[1].nombre}</h2>
        <div className="contenedor-principal">
          <div className="seccion-izquierda">
            <div className="galeria-fotos">
              <Image
                src={alojamientosMock[1].fotos[0]?.path}
                alt={alojamientosMock[1].fotos[0]?.descripcion}
                width={505}
                height={286}
                objectFit="cover"
              ...
              <div className="fotos-secundarias">
                {alojamientosMock[1].fotos.slice(1, 5).map((foto, index) => (
                  <Image
                    key={index}
                    src={foto.path}
                    alt={`${alojamientosMock[1].nombre} - ${foto.descripcion}`}
                    width={120}
                    height={80}
                    objectFit="cover"
                  />
            ...
            <div className="detalles">
              ...
              <div className="caracteristicas-container">
                ...
                <div className="lista-caracteristicas">
                  {alojamientosMock[1].caracteristicas.map((caract, index) => (
              ...
              <div className="horarios-container">
                ...
                <div className="horario-item">
                  ...
                  <span>Check-in: {alojamientosMock[1].horarioCheckIn}</span>
                </div>
                <div className="horario-item">
                  <FaClock className="icono-horario" />
                  <span>Check-out: {alojamientosMock[1].horarioCheckOut}</span>
                </div>
              </div>
            </div>
            ...
            <div className="descripcion">
              <h2>Descripción</h2>
              <p>{alojamientosMock[1].descripcion}</p>
            </div>
            <div className="ubicacion">
              <h2>Ubicación</h2>
              <p>Pais: {alojamientosMock[1].direccion.ubicacion.pais}</p>
              <p>Ciudad: {alojamientosMock[1].direccion.ubicacion.ciudad}</p>
            </div>
            </div>
          </div>
